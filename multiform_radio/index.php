...
<form>
                                	<table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size: 11px;" id="stepTable">
                                      <tr class="stepSelected">
										...
										<td class="stepEdit"><input type="radio" name="edit" id="formstep1" checked class="pointer placeEdit" value="Edit" /></td>
										</tr><tr >
                                        <td class="formStep">Address</td>
										<td class="stepEdit"><input type="radio" name="edit" id="formstep2" class="pointer placeEdit" value="Edit" /> </td>
										</tr><tr >
                                        <td class="formStep">Interests:</td>
										<td class="stepEdit"><input type="radio" name="edit" id="formstep3" class="pointer placeEdit" value="Edit" /></td>
										</tr>
